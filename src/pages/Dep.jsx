...
const Department = () => {
  return (
    <Helmet title="dep">
      <CommonSection title="Department" />
      <AboutSection aboutClass="depPage" />

      <section className="dep__page-section">
        <Container>
          <Row>
            <Col lg="6" md="6" sm="12">
              <div className="dep__page-img">
                <img src={driveImg} alt="" className="w-100 rounded-3" />
              </div>
            </Col>

            <Col lg="6" md="6" sm="12">
              <div className="dep__page-content">
